...
public class ExchangeRate extends javax.swing.JFrame {
    ...
    String API_PROVDIER = 
        ...
        String[] code = {"MXN","AUD","HKD","RON","HRK","CHF","IDR",
                ...
                "MYR","ZAR","ILS","GBP","SGD","HUF","EUR","CNY","TRY",
                "SEK","RUB","NZD","KRW","THB","BGN","DKK"};
    ...
    private void initComponents() {
        ...
        lblClock.setForeground(new java.awt.Color(0, 204, 0));
    ...
    private void addResponseToList(String base){
        ...
        + "/latest?"
        + "apikey=izCJ3T7fxUnJdnG7b0aFt2LELcQYHOyK"
        + "&base=" + base + ""
        );
        if(response != null){
            rates.clear();
